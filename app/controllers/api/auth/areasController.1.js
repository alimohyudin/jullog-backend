...
module.exports = class AreasController {
    ...
    getTreesGraphData(req, res){
        ...
        req.getValidationResult().then(async(result) =>{
            ...
            let properties = [
                            ...
                            {'fieldName':'yourAssessment', 'graphName': 'Din vurdering af træet', 'defaultValues': ['Prima','Standard','Uklassificeret']},
    ...
    getTreeHeightVsAssessmentGraphData(req, res){
        ...
        req.getValidationResult().then(async(result) =>{
            ...
            /* if(req.body.fromDate && req.body.toDate)
                match['createdAt'] = {$gte: new Date(req.body.fromDate), $lte: new Date(req.body.toDate)};
            else if(req.body.fromDate)
                match['createdAt'] = {$gte: new Date(req.body.fromDate)};
            else if(req.body.toDate)
                match['createdAt'] = {$lte: new Date(req.body.toDate)}; */
